          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{ auth()->user()->name }}</span>
                    @switch(auth()->user()->role)
                        @case("employe")
                            <span class="user-status badge rounded-pill badge-glow bg-primary">موضف</span>  
                            @break
                        @case("monitor")
                            <span class="user-status badge rounded-pill badge-glow bg-warning">مراقب</span>  
                            @break
                        @case("admin")
                            <span class="user-status badge rounded-pill badge-glow bg-info">مدير  علي الفرع </span> 
                            @break
                        @case("super-admin")
                            <span class="user-status badge rounded-pill badge-glow bg-danger">مدير  علي النظام </span>
                            @break
                        @default
              ...
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}">
                    <i class="me-50" data-feather="power"></i> تسجيل خروج
                </a>
              </div>
          </li>
      </ul>

          ...
          <table class="table table-bordered">
            ...
            <tbody class="table-border-bottom-0">
                @if (isset($request->request))
                    ...
                    <tr>
                        <td>
                            <a title="طباعة التحليل" target="_blank"  href="{{url("/print/patient/$request->id/request/$patientRequest->id")}}" ><i class='bx bxs-printer bx-tada' style='color:#a29e9e' ></i></a>
                        </td>
                        <td>
                            <a title="عرض نتيجة التحليل" data-bs-toggle="modal"data-bs-target="#modalCenter"id="createModalOpen" data-result="{{$patientRequest->results}}" href="#" >
                                <i class='bx bxs-show' style='color:#033dea'  ></i>

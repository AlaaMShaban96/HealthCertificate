@extends('new2.layout.app',['title' => "الحالات",'subtitle'=>'قائمة الحالات'])
          ...
          <div class="card-body row">
            ...
            <div class="row justify-content">
              <div class="col-sm-10">
                ...
                <button type="submit" class="btn btn-danger btn-buy-now delete" title="حدف جميع السجلات"><i data-feather='delete'></i> حدف </button>
              </div>
            </div>
          </div>
        </form>
